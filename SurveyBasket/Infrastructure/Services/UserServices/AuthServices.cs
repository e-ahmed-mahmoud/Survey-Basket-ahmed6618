...
namespace SurveyBasket.Infrastructure.Services.UserServices;
...
ILogger<AuthServices> logger, RoleManager<ApplicationRole> roleManager, IApplicationDbContext dbContext) : IAuthServices
{
